...
import { HighlightedName, NameKind } from './PowerFxSyntaxTypes';
...
const expandedEditorHeight: number = 7 * oneLineHeight;
...
export class PowerFxFormulaEditorBase extends React.Component<
  PowerFxFormulaEditorProps,
...
> {
      ...
      <div id="root" className={classNames.root}>
        <div id="formulaEditor" className={classNames.formulaEditor}>
          <FormulaEditor
            ...
            height={expanded ? expandedEditorHeight : height}
  ...
  private _getHeight(): number {
    ...
    if (this._editor && this._model && !this._model.isDisposed()) {
      ...
      // For now limit calculation of height for lineCount > 1
      if (lineCount > 1) {
